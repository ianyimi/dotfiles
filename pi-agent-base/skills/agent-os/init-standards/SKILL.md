---
name: init-standards
description: Set up project standards by detecting dependencies, fetching library docs (checking llms.txt first), generating use-case standards, and updating the standards index.
---
